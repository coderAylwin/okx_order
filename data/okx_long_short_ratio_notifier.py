        ...
        try:
            ...
            if current_oi:
                ...
                if current_oi.get('oi_usd') is not None:
                    ...
                    if oi_usd_value >= 1000000000:  # 大于10亿
                        oi_usd_display = f"{oi_usd_value / 1000000000:.2f} 十亿美元"
                    elif oi_usd_value >= 1000000:  # 大于100万
                        oi_usd_display = f"{oi_usd_value / 1000000:.2f} 百万美元"
                    else:
